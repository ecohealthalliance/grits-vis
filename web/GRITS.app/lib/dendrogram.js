...
(function (tangelo, $, d3) {
    ...
    tangelo.widget("tangelo.dendrogramLocal", {
        options: {
        ...
        _update: function () {
            this.width = this.element.width() - this.options.margin.right - this.options.margin.left;
            this.height = this.element.height() - this.options.margin.top - this.options.margin.bottom;
